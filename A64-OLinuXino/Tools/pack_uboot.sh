...
dtc -Odtb -o $BUILD/a64-olinuxino.dtb $BLOBS/a64-olinuxino.dts
...
$SUNXI_PACK_TOOLS/update_uboot_fdt $BUILD/u-boot-merged2.bin $BUILD/a64-olinuxino.dtb $BUILD/u-boot-with-dtb.bin
